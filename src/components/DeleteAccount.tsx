...
const DeleteAccount = ({ isPhoneCode = false }) => {
        ...
        <>
          <Grid item xs={12}>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Typography fontFamily={'inter-bold'}>Удаление аккаунта</Typography>
              </Grid>
              <Grid item xs={12}>
                {isPhoneCode ? (
            ...
            <Typography className={authClasses.helperInfo} mt={2} textAlign="left">
              Не пришел код?{' '}
              <Typography
                component="span"
