  ...
  return (
    <Layout>
      <Head>
        ...
        <meta property="og:title" content={'Реквизиты'} key="title" />
      </Head>
      <SubHeader />
      <Hidden mdDown>
        <Grid container>
          ...
          <Grid item xs={9}>
            <Box className={classes.rightBox}>
              <Requisites value={value} index={2} />
            </Box>
          </Grid>
        </Grid>
      </Hidden>
...
const SettingsWrappedProfileProvider = () => (
  <ProfileProvider>
    <Settings />
  </ProfileProvider>
);

export default SettingsWrappedProfileProvider;
